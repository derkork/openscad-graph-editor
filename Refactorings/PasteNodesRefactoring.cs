...
namespace OpenScadGraphEditor.Refactorings
{
    ...
    {
        public static readonly RefactoringDataKey<List<ScadNode>> PastedNodes
            = new RefactoringDataKey<List<ScadNode>>();
        ...
        public PasteNodesRefactoring(ScadGraph targetGraph, ScadGraph sourceBuffer, Vector2 position,
            bool pasteCopy = true)
        {
        ...
        public override void PerformRefactoring(RefactoringContext context)
        {
            ...
            context.StoreRefactoringData(PastedNodes, scadNodes);
        }
    }
}