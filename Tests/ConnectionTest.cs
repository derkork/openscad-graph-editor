...
namespace OpenScadGraphEditor.Tests
{
    ...
    public class ConnectionTest  : MainWindowTest
    {
        ...
        public async Task SimpleConnectionCanBeRemoved()
        {
            ...
            await WithinSeconds(3, () =>
            {
                Assert.False(MainWindow.GraphEditor.HasConnection(constructVector3, Port.Output(0), cube, Port.Input(0)),
        ...
        public async Task RerouteGeometryPortsCanTakeMultipleConnections()
        {
            ...
            // when
            // i drag a connection from both cube nodes' output ports to the reroute's first input port
