...
namespace OpenScadGraphEditor.Nodes
{
    ...
    public class GreaterEqualOperator : BinaryComparisonOperator
    {
        ...
        public override string NodeDescription =>
            "Compares if the first operand is greater than or equal to the second operand.";
        ...
        public override bool Supports(PortType portType)
        {
            ...
            return portType == PortType.Number || portType == PortType.String || portType == PortType.Boolean ||
